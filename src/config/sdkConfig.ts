...
export const clmmTestnet: SdkOptions = {
  ...
  export const coin_type_a = `${TestnetSDK.sdkOptions.faucet?.package_id}::usdt::USDT`
  export const coin_type_b = `${TestnetSDK.sdkOptions.faucet?.package_id}::usdc::USDC`
  ...
  export const liquidityInput = ClmmPoolUtil.estLiquidityAndcoinAmountFromOneAmounts(
      lowerTick,
      upperTick,
      fix_coin_amount,
      fix_amount_a,
  ...
  export const amount_a = fix_amount_a ? fix_coin_amount.toNumber() : liquidityInput.tokenMaxA.toNumber()
  export const amount_b = fix_amount_a ? liquidityInput.tokenMaxB.toNumber() : fix_coin_amount.toNumber()
